...
namespace OnlineFoodOrdering.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            await LoadAsync(user); // Call LoadAsync to populate data
            return Page();
        }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToPage("EmailConfirmation"); // Redirect to a confirmation page
                }
